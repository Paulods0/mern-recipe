      ...
      <div className="w-[1200px] mx-auto flex items-center justify-between ">
        ...
        <section>
          <div className="relative flex items-center gap-3">
            <div className="border-solid px-2 flex items-center justify-center border-r-gray-200 border-r-2">
            ...
            {active && cookies.access_token ? (
              <motion.div
                ...
                className="absolute top-[44px] right-[65px] shadow-2xl z-10 bg-zinc-800 px-3 py-4 items-center w-[250px] flex flex-col gap-2 rounded-tl-2xl rounded-bl-2xl rounded-br-2xl"
              >
                ...
                <button
                  className="text-zinc-800 text-[12px] bg-white p-2 rounded  mb-2"
